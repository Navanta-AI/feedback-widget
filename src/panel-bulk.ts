...
import { ICON_CLOSE_SM } from "./icons.js";
import type { TFunction } from "./i18n/index.js";
import type { ThemeColors } from "./styles/theme.js";

// ---------------------------------------------------------------------------
// Checkbox control glyphs (form control, not part of the icon set) — DS neutral:
// unchecked = hairline square, checked = solid primary fill with an inverse tick.
// ---------------------------------------------------------------------------
...
export const ICON_CHECKBOX_CHECKED = `<svg viewBox="0 0 18 18" fill="none" aria-hidden="true"><rect x="1" y="1" width="16" height="16" rx="4" fill="var(--sp-primary)" stroke="none"/><polyline points="5 9 8 12 13 6" fill="none" stroke="var(--sp-primary-fg)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
...
export class BulkActions {
  ...
  constructor(
    ...
    deselectBtn.appendChild(parseSvg(ICON_CLOSE_SM));

...
export interface WidgetEvents {
  ...
  /** A batch of feedbacks was imported from a JSON file via the panel. The
   *  launcher listens to drop markers for any that land on the current page. */
  "feedback:imported": [FeedbackResponse[]];

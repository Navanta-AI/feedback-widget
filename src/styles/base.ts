  ...
  return `
    ...
    *, *::before, *::after {
    ...
    .sp-search:focus {
      ...
      box-shadow: 0 0 0 3px color-mix(in srgb, var(--sp-ring) 50%, transparent);
    ...
    .sp-filter-dropdown-section + .sp-filter-dropdown-section,
    .sp-filter-dropdown-option + .sp-filter-dropdown-section {
      margin-top: 4px;
      border-top: 1px solid var(--sp-glass-border-subtle);
      padding-top: 8px;
    }
    ...
    /* ---- Tabs variant — Navanta portal "underline" Tabs (page scope) ----
       Mirrors the DS Tabs underline variant: no container baseline; the
       active tab's label sits in a soft rounded pill (--surface-hover) with a
       2px text-primary underline beneath it. Inactive tabs are text-secondary
       and reveal the same pill on hover. */
    ...
    .sp-segmented--tabs .sp-segmented__btn {
      height: auto;
      padding: 8px 0;
      border-radius: 0;
      background: transparent;
    ...
    .sp-segmented--tabs .sp-segmented__label {
      display: inline-flex;
      align-items: center;
      padding: 2px 8px;
      border-radius: var(--sp-radius);
    ...
    .sp-segmented--tabs .sp-segmented__btn:hover {
      color: var(--sp-text);
      background: transparent;
    }

    .sp-segmented--tabs .sp-segmented__btn:hover .sp-segmented__label {
      background: var(--sp-secondary);
    }

    .sp-segmented--tabs .sp-segmented__btn--active {
      background: transparent;
      color: var(--sp-text);
      font-weight: 600;
      box-shadow: none;
    ...
    .sp-segmented--tabs .sp-segmented__btn--active .sp-segmented__label {
      background: var(--sp-secondary);
    }

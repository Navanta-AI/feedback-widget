...
export interface Translations {
  ...
  // Import controls — optional so existing locale dictionaries stay valid;
  // the per-key English fallback in `createT` covers missing entries.
  "import.label"?: string;
  "import.success"?: string;
  "import.error"?: string;
  "import.aria"?: string;

  // Combined filter dropdown trigger (status + type sections).
  "filter.label"?: string;
}
